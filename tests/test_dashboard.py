...
def test_dashboard_counts_reminders_sent_in_period(admin_client: TestClient):
    ...
    # 🔴 Los dos bordes salen del reloj **local**: el rango del dashboard
    # significa días del negocio (ver `_day_range_utc`), así que un borde en UTC
    # deja afuera todo lo que pasa entre las 21:00 y las 24:00 de Argentina.
